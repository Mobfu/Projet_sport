...
public class ServletAllClubRadius extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOGGER.log(Level.INFO, "Received parameters: lonInput={0}, latInput={1}, fede={2}, rayon={3}",
                new Object[]{ourLng, ourLat, rayon});
        ...
        ArrayList<Club> listClub = clubdao.getAllClubByRadius(longitude,latitude, radius);
