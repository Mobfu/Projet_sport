	...
	<section
		...
		<div class="container my-5 py-5">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<p class="texte-capitalize py-3 redressed banner-desc "
						style="color: white;">Bienvenue à vous membre Elu</p>
				</div>
					...
					<div class="row g-0">
						...
						<div class="col-md-6">
							<div class="card-body">
								...
								<p class="card-text">Vous pouvez avoir accès aux nombres
									d'habitants licenciés par commune,régions,départements ainsi
									que les fédérations auquels ces nombres apparatiennent.Vous
									pouvez également avoir le détail du genre intervenant dans ces
									statisitiques</p>
								<p class="card-text">
						...
						<div class="col-md-6">
							<div class="card-body">
								...
								<p class="card-text">Un document contenant les chiffres des
									habitants non répertoriés de certaines fédérations sportives
									offre une vision précise et exhaustive de la démographie des
									pratiquants dans le domaine du sport.En mettant en lumière ces
									chiffres non répertoriés, le document fournit des informations
									cruciales pour orienter les politiques de développement du
									sport, promouvoir l'inclusion et la diversité, et renforcer
									l'accès équitable à la pratique sportive pour tous.</p>
								<p class="card-text">
								...
								<div class="row g-0">
									...
									<div class="col-md-6">
										<div class="card-body">
											...
											<p class="card-text">En compilant ces données, nous
												pouvons dresser un tableau clair de l'implication des
												habitants dans les activités sportives, en mettant en
												évidence les endroits où le sport joue un rôle significatif
												dans la vie quotidienne.Cette analyse comparative offre des
												insights utiles pour les décideurs politiques,comme vous en
												les aidant à identifier les régions où des initiatives de
												promotion du sport pourraient être les plus bénéfiques,
												ainsi qu'à comprendre les facteurs socio-économiques qui
